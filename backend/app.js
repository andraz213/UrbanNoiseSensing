...
wss.on('connection', socket => {
    socket.on('message', message => {
        ...
        if(dataObj.type == 'SENSOR_READING') {
            ...
            console.log("sadfdsafsdfsafdsfsffSDFDASJFLDKFJLDSKFJADSLKČFJDASLFKJDSAFLČKDJFČLDASJFČADSKFJASLČ")
            PostSensorTelemetryWebsockets(message).then(r => console.log(r));
        }
    });
});
